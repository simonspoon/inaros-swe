...
Output: a product-spec the planner can slice. Talk to the user in plain language — no tech terms, frameworks, or data structures.
...
## Done
User confirms spec matches need. No handoff before confirm.
